    ...
    <div className="flex flex-col sm:w-1/2 w-screen">
      ...
      <div className="sm:ml-20 ml-10 mt-14">
        <div className="flex items-center h-14 w-5/6 sm:w-4/5 border-2 border-slate-300 rounded-lg">
          ...
          />
          <FontAwesomeIcon icon={faFileUpload} className="m-2 cursor-pointer" />
      ...
      <h3 className="text-center text-sm sm:text-lg mt-10 text-black-500 text-opacity-70">
        Edit Contents
      </h3>
